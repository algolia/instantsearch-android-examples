...
* Use [github issues](https://github.com/algolia/instantsearch-android-examples/issues) to report a bug.
* Before creating a new issue:
  * Make sure you are using the [latest release](https://github.com/algolia/instantsearch-android/releases).
  * Check if the issue was [already reported or fixed](https://github.com/algolia/instantsearch-android-examples/issues?utf8=%E2%9C%93&q=is%3Aissue). Notice that it may not be released yet.
...
1. Fork the InstantSearch Android Examples repository.
2. Clone your forked project into your developer machine: `git clone git@github.com:<your-github-username>/instantsearch-android-examples.git`
3. Add the original project repo as upstream repository in your forked project: `git remote add upstream git@github.com:algolia/instantsearch-android-examples.git`
...
* We use `type: feature request` label to mark all [feature request issues](https://github.com/algolia/instantsearch-android-android/labels/type%3A%20feature%20request).
